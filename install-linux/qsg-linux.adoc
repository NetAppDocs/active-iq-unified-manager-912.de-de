...
* Betriebssystem: Red hat Enterprise Linux Versionen 7.x und von 8.0 bis 8.6 oder CentOS Version 7.x basierend auf x86_64 Architektur, installiert unter Verwendung der „Server mit GUI“ Basisumgebung aus der Option *Software Selection* des OS Installers
